...
import {View,Text , TouchableOpacity, ScrollView, StyleSheet, Image, FlatList, ImageBackground, Dimensions, Share} from 'react-native'
...
const advert = firebase.admob().interstitial('ca-app-pub-1023595993469094/1199771844')
...
constructor(props) {
    ...
    this.state = {
	  ...
	  componentDidMount = () => {
    firebase.database().ref('/motivational').once('value')
     .then((dataSnapshot) => {
 ...
 render () {
       ...
       <TouchableOpacity style={styles.toolbarButton}  onPress={() => this.goBack()}>
        ...
        <Text style={styles.toolbarTitle}>Motivational Quotes</Text>
 ...
 <Banner
    ...
    size={"SMALL_BANNER"}
  unitId={"ca-app-pub-1023595993469094/8148323575"}
