...
const advert = firebase.admob().interstitial('ca-app-pub-1023595993469094/9150661479')
...
export default class Sponsoring extends Component {
  ...
  componentDidMount = () => {
    firebase.database().ref('/hope').once('value')
     .then((dataSnapshot) => {
 ...
 render () {
       ...
       <TouchableOpacity style={styles.toolbarButton}  onPress={() => this.goBack()}>
        ...
        <Text style={styles.toolbarTitle}>Hope Quotes</Text>
