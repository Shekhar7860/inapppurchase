...
import {View,Text , TouchableOpacity, ScrollView, StyleSheet, Share,Image, ImageBackground, Dimensions, FlatList} from 'react-native'
...
const advert = firebase.admob().interstitial('ca-app-pub-1023595993469094/4485314698')
...
export default class BirthDays extends Component {
 ...
 render () {
       ...
       <TouchableOpacity style={styles.toolbarButton}  onPress={() => this.goBack()}>
        ...
        <Text style={styles.toolbarTitle}>Happiness Quotes</Text>
 ...
 <Banner
    ...
    size={"SMALL_BANNER"}
  unitId={"ca-app-pub-1023595993469094/6979508297"}
