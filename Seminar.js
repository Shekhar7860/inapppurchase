...
import {View,Text , TouchableOpacity, ScrollView, StyleSheet, Share, Image, ImageBackground, FlatList, Dimensions} from 'react-native'
...
const advert = firebase.admob().interstitial('ca-app-pub-1023595993469094/3634363498')
...
share = (item) => {
  ...
  componentDidMount = () => {
    firebase.database().ref('/planning').once('value')
     .then((dataSnapshot) => {
 ...
 render () {
       ...
       <TouchableOpacity style={styles.toolbarButton}  onPress={() => this.goBack()}>
        ...
        <Text style={styles.toolbarTitle}>Planning Quotes</Text>
 ...
 <Banner
    ...
    size={"SMALL_BANNER"}
  unitId={"ca-app-pub-1023595993469094/9825163485"}
